...
public final class PdocEngineDemo {

    private PdocEngineDemo() {}

    public static void main(String[] args) {
        PdocEngine engine = new PdocEngine();
        ...
        System.out.printf("Prob. simulada > 5%%: %.2f%%%n", result.simulationProbabilityOverFivePercent() * 100);
        System.out.printf("Prob. simulada > 10%%: %.2f%%%n", result.simulationProbabilityOverTenPercent() * 100);
        System.out.println("Prob. calibrada > 5%: " + result.calibratedProbabilityOverFivePercent());
        System.out.println("P10: R$ " + result.costP10());
        System.out.println("P50: R$ " + result.costP50());
        System.out.println("P80: R$ " + result.costP80());
        System.out.println("P95: R$ " + result.costP95());
        System.out.println("EAC ponderado: R$ " + result.evm().weightedEstimateAtCompletion());
