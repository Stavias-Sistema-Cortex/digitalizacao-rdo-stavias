...
public class ServicePriceVersionSyncOperationHandler
    ...
    public AppliedSyncMutation apply(
        ...
        return new AppliedSyncMutation(
                entityType(), entityId, mapper.valueToTree(result)
        );
    }
    ...
    private ServicePriceVersion create(
        ...
        requireRelated(mutation.relatedEntities(), "SERVICE", serviceId, "serviceId");
    ...
    private void requireRelated(
        ...
        boolean matches = related != null && related.stream().anyMatch(item ->
                item != null
