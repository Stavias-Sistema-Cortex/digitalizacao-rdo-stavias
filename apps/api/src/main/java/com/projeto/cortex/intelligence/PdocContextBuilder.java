...
/**
 * Converte dados operacionais brutos do Córtex em um PdocContext.
 *
 * Responsabilidades:
 * - normalizar valores;
 ...
 * - proteger o PdocEngine de dados brutos inconsistentes.
 *
 * Ainda não acessa banco de dados.
 */
public final class PdocContextBuilder {

    private static final int DEFAULT_SIMULATION_ITERATIONS = 10_000;

    public PdocEngine.PdocContext build(PdocSourceSnapshot source) {
     ...
     *
     * Cada bloco representa uma família de dados importante para o PDOC.
     */
    ...
    private void validate(PdocSourceSnapshot source) {
     ...
     */
    public record PdocSourceSnapshot(
        String obraId,
