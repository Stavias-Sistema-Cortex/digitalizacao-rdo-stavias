...
public record PdocInputBundle(
    ...
    public PdocContextBuilder.PdocSourceSnapshot toSourceSnapshot() {
        if (!canCalculate()) {
            throw new IllegalStateException(
                    "Dados insuficientes para montar o contexto do PDOC."
            );
        }
