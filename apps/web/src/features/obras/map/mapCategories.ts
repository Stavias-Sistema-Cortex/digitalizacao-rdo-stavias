...
const FALLBACK: Readonly<Record<string, string>> = Object.freeze({
  ...
  "--map-execucao-hoje": "#f2c300",
  "--map-execucao-recente": "#c89b00",
  "--map-execucao-consolidada": "#2f6f68",
  "--map-execucao-encerrada": "#66706b",
