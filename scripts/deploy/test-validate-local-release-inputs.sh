...
valid_api='ghcr.io/stavias-sistema-cortex/digitalizacao-rdo-stavias-api@sha256:6c64976326ee90cfc57b487e34174095a5fd74a705979cc0cb23f8fa74bf4244'
valid_web='ghcr.io/stavias-sistema-cortex/digitalizacao-rdo-stavias-web@sha256:79b7d935c480954c1a93e1e827fa4b7126c546210d5b77b2a57535a5b680b1e9'
...
export validator valid_sha valid_marker valid_api valid_web

run_validator

expect_rejected 'a short release SHA' CORTEX_TEST_SHA=63f315df
expect_rejected 'a mutable API tag' CORTEX_TEST_API_IMAGE=ghcr.io/stavias-sistema-cortex/digitalizacao-rdo-stavias-api:production
