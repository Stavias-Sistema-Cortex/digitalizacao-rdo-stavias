...
bash "$repo_root/scripts/security/test-production-caddy-contract.sh"
bash "$postgres_role_contract"
bash "$repo_root/scripts/deploy/test-local-release-handoff.sh"
bash "$repo_root/scripts/deploy/test-local-release-agent.sh"
